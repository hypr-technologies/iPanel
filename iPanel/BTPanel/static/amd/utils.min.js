			...
			if (my_headers) {
				$.ajaxSetup({
					...
					<ul class="help-info-text">\
						...
						<li style="list-style: none;">2. If the above attempts fail to resolve this error, please screenshot this window and post it to the Pagoda Forum for help, forum address:<a class="btlink" href="https://www.infuze panel.com/forum" target="_blank">https://www.infuze panel.com/forum</a></li>\
					</ul>\
				</div>';
							} else {
											...
											if (isErrorHead) {
												...
												content =
													'<div>\n                <h3 style="margin-bottom: 10px;">Something went wrong, an error occurred while the panel was running!</h3>\n                <pre style="height:635px;word-wrap: break-word;white-space: pre-wrap;margin: 0 0">'.concat(
														errorBody.trim(),
														'</pre>\n                <ul class="help-info-text">\n                  <li style="list-style: none;"><b>Sorry, an unexpected error occurred while panel was running, please try to resolve this error in the following order: </b></li>\n                  <li style="list-style: none;">1. Click Fix Panel in the upper right corner of [Home] and log out of the panel to log in again.</li>\n                  <li style="list-style: none;">2. if the above attempts fail to lift this error, please screenshot this window to the Infuze Panel Forum to post for help, forum address: <a class="btlink" href="https://www.infuze panel.com/forum" target="_blank">https://www.infuze panel.com/forum</a></li>                </ul>\n              </div>'
													);
											} else {
												content = resText;
											}
				...
				content: {
					...
					template: function () {
						return (0, snabbdom_2.jsx)(
							...
							(0, snabbdom_2.jsx)('p', { class: { 'text-right': true } }, ' ', this.$link({ title: lan.public_backup.no_account, href: 'https://brandnew.infuze panel.com/user_admin/register' }))
						);
					},
					methods: {
