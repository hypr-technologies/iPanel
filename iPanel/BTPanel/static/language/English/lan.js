var lan = {
	...
	"index":{
		...
		"bind_bt_account_first":"Please bind your Infuze Panel account first!",
		...
		"update":"Update",
		"find_bug_reward":"Find bugs, get Infuze Panel coins",
	...
	"config":{
		...
		"config_user_binding":"Binding your Infuze Panel account",
		"config_user_edit":"Change Infuze Panel account",
		"binding":"Bind",
		"token_get":"Getting token...",
		"user_bt":"Username",
		"pass_bt":"Password",
		"binding_un_msg":"Are you sure to unbind Infuze Panel account？",
		...
		"open_small_app":"Open the Infuze Panel panel Mini Program",
		"qrcore_of_small_app":"QR code of Mini Program",
		"scan_qrcore_with_small_app":"Use Infuze Panel Mobile to scan the current QR code to bind the panel",
		"return_bind_list":"Return to the panel binding list",
		"read_bind_list":"View binding list",
		"bind_wechat":"Bind WeChat",
		"no_bind_bt_account":"Infuze Panel account NOT bound",
	...
	"firewall":{
		...
		"bt_default_port":"Default port of Infuze Panel",
	...
	"bt":{
		...
		"panel_add":"Add Infuze Panel association",
	...
	"files":{
		...
		"swap_file":"PS: SWAP swap partition file set by default by Infuze Panel",
		...
		"ps_swap":"PS: Infuze Panel default swap virtual RAM file",
		...
		"upload_files_tips1":"PS: Infuze Panel file upload temporary file, re-upload resume from breakpoint, can be deleted",
	...
	"soft":{
		...
		"bt_developer":"Security Reminder: Infuze Panel officially conducted a security audit before the third-party plug-in was put on the shelves, but there may be security risks. Please check it out before using it in the production environment.",
		...
		"author":"Author",
		"source":"Source",
		"third_party_apps_tips1":"This is a plugin developed by a third party, Infuze Panel can not verify its reliability!",
...
"ssl_save":"Save and enable SSL",
		...
		"bt_bind_no":"Not bound to Infuze Panel account, please register and bind. After binding Infuze Panel account (non-forum account), you can deploy SSL with one click",
		"bt_user":"Infuze Panel Account",
		"bt_user_first":"Account",
		"login":"Login",
		"bt_reg":"Register Infuze Panel account",
		"bt_ssl_help_1":"Infuze Panel SSL certificate is issued by TrustAsia, requires real name identification",
		"bt_ssl_help_2":"If you have Infuze Panel account, please log in and bind it",
		"bt_ssl_help_3":"Infuze Panel SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for Infuze Panel users!",
		...
		"bt_ssl_help_6":"Infuze Panel SSL certificate is the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain.",
        ...
        "ssl_tips2": "Infuze Panel SSL applys for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports single domain name application.",
        ...
        "ssl_tips6": "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.infuze.local/yunwei' target='_blank'>Infuze Panel provides certificate deployment service 50 yuan Once</a>",
"ssl_tips7": "When no SSL default site is specified, a site without SSL will use HTTPS to access the site with SSL enabled",
        ...
        "dns_check_tips3": "Before using the [Infuze Panel DNS Cloud Resolution] API, you need to confirm that the domain DNS for which you want to apply for SSL certificate is [Cloud Resolution]",
        ...
        "dns_resolve_tips2": "Domain resolution can be manually verified by the CMD command: nslookup-q=txt _ acme-challenge.infuze.local",
        "dns_resolve_tips3": "If you are using the Infuze Panel Cloud Resolution plugin, Ali Cloud DNS,DNSPod as a DNS, you can set auto-resolution with the DNS API",
		...
		"add_site":{
			...
			"bath_tips8":"Eq, infuze.local,test.cn:8081|/www/wwwroot/infuze.local|1|1|56",
		...
		"set_ssl": {
			...
			"official_use":"Official recommendation (infuze panel.com is also used)",
			...
			"bus_tip3":"Apply for www.infuze panel.com certificate with www as the secondary domain name, binding and resolving the top-level domain (infuze panel.com) is required, otherwise the verification will fail",
			"bus_tip4":"Compared with ordinary certificates, commercial certificates have higher security, compensation protection and support for wildcard and multi-domain names <a class=\"btlink\" href=\"https://www.infuze panel.com/forum/d/19277-business-ssl-certificate-tutorial\" target=\"_blank\">how to validate the commercial certificate?</a>",
			...
			"cust_place":"single domain, e.g. www.infuze.local",
			...
			"cust_tip2":"To apply for the certificate that uses www as the second-level domain name www.infuze.local, you need to bind and resolve the top-level domain name (infuze.local); otherwise, the verification fails",
			"cust_tip3":"Optional name gift rules for SSL certificates:",
			"cust_tip4":"Apply for a root domain name (e.g.infuze.local) and give away a www domain name (e.g. www.infuze.local)",
			"cust_tip5":"Apply for a domain name whose host is www (e.g. : www.infuze.local), and give away a domain name of the upper level (e.g. : infuze.local).",
			"cust_tip6":"Apply for another second-level domain name (e.g.app.infuze.local), and give away a domain name with the next level www (e.g. www.app.infuze.local).",
			...
			"more_cert_pl1":function(num){
				return 'Multi-domain wildcard certificate, one domain name per line, support '+ num +' domain names, mandatory fields, such as \r*.infuze.local\r*.btest.cn'
			},
			"more_cert_pl2":function(num){
				return 'Multiple domain name certificate, one domain name per row, supports '+ num +' domain names, for example, \rwww.infuze.local\rwww.bttest.cn'
			},
	...
	"public":{
		...
		"logout":"Log out",
		"bt_terminal":"Infuze Panel terminal",
	...
	"public_backup":{
		...
		"cp_success":"Successfully copied",
		"cp_fail":"Failed to copy, browser is not compatible!",
		"bind_bt_account":"Bind Infuze Panel account",
		...
		"cancel":"Cancel",
		"unbind":"Unbind",
		"open_bt_small_app":"Open the Infuze Panel panel mini program",
		"app_qr_core":"Mini program QR code",
		"scan_qr_core":"Use Infuze Panel Mobile to scan the current QR code and bind to the panel",
    ...
    "year3": "3 years",
    "permanent": "Permanent",
    "buy_multiplev_bt_pro": "Note: If you need to purchase multiple permanent licenses, please visit the Infuze Panel official site to purchase",
    "goto_bt": "Go to Infuze Panel official site",
	...
	"login":{
		"qr_core_login":"Infuze Panel Mobile QR code login",
		"open":"Open",
		"bt_small_p":"Infuze Panel Mobile",
	...
	"webhook":{
		...
		"read_key":"View key",
		"test":"Test",
		"use_method":"How to use Infuze Panel WebHook:",
	...
	"one_click":{
		...
		"one_click":"Infuze Panel one-click",
