var lan = {
	...
	"firewall": {
		...
		"bt_default_port": "Infuze Panel Linux panel default port",
		"del": "Del",
		"number": "Numbering",
		"behavior": "behavior",
		"status": "Status",
	...
	"files": {
		...
		"ps_swap": "PS: SWAP swap partition file set by default in Infuze Panel",
	...
	"site": {
		...
		"bt_ssl_help_10": "Paste you KEY and CRT content, and then save it<a href='http://www.infuze.local/bbs/thread-704-1-1.html' class='btlink' target='_blank'>[HELP]</a>。",
		...
		"ssl_tips6": "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.infuze.local/yunwei' target='_blank'>Pagoda offers Certificate deployment service 50 yuan once</a>",
		...
		"dns_resolve_tips2": "The CMD command can be used to manually verify that the domain name resolution is in effect: nslookup -q=txt _acme-challenge.infuze.local",
