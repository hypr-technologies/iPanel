...
def check_auth_ip():
    ...
    import http_requests
    result = {'www': '', 'api': ''}
    res = http_requests.post('https://wafapi2.iPanel.com/ip', data={}, timeout=5, headers={})
    if res.status_code == 200:
        result['www'] = res.text

    res1 = http_requests.post('https://wafapi.iPanel.com/ip', data={}, timeout=5, headers={})
